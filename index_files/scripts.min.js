...
/* PrismJS 1.16.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+json */
...
$(document).ready(function() {
  ...
  // Dark Mode Toggle
  // ================================
  if ($(".nav-dark-mode").length > 0) {
    $(".nav-dark-mode").click(function() {
  ...
  // Table of Contents
  // ================================
  if ($('.post-full-content').hasClass('with-toc')) {
    tocbot.init({
      tocSelector: '.toc',
